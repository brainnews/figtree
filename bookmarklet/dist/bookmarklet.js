javascript:(function(){'use strict';const FIGTREE_CONFIG={baseUrl: 'https://cdn.jsdelivr.net/gh/yourusername/figtree@bookmarklet/bookmarklet/dist/',appScript: 'figtree-app.min.js',version: '2.0.0-bookmarklet'};if (window.FigtreeApp){window.FigtreeApp.toggle();return;}if (window.FigtreeLoading){return;}window.FigtreeLoading=true;const loadingIndicator=document.createElement('div');loadingIndicator.id='figtree-loading';loadingIndicator.innerHTML=`
<div style="
